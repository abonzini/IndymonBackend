...
namespace AutomatedTeamBuilder
{
    public static partial class TeamBuilder
    {
        ...
        /// <returns></returns>
        static double GetAbilityWeight(Ability ability, TrainerPokemon theMon, PokemonBuildInfo monCtx, TeamBuildContext buildCtx, bool isFirstMon)
        {
            ...
            double score = 1;
            if (ability.Flags.Contains(EffectFlag.BANNED)) // Banned abilities can never be chosen
            {
                return 0;
            }
            else
